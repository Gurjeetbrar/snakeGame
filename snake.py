...
class Apple:
    ...
    def draw(self):
        ...
        pygame.display.flip()
    def move(self):
        self.x = random.randint(0,24)*SIZE # we want to keep apple in cetain squares in which snake moves
...
class Snake:
    def __init__(self, parent_screen,length):
        ...
        self.x = [SIZE]*length # here we have given value as size just to keep some number in our array
        self.y = [SIZE]*length
...
class Game:
    ...
    def play(self):
        ...
        if self.isCollisionBoundary(self.snake.x[0], self.snake.y[0]):
            self.playSound("crash")
    ...
    def isCollisionBoundary(self,x,y):
    ...
    def show_game_over(self):
        ...
        self.surface.blit(line1,(325,225))
